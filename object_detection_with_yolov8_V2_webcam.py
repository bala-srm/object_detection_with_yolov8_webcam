...
# capture a frame from the video
    ...
    print(results) # printing just to show the contents of the results object
    ...
    for cls,bbox in zip(classes,bboxes):
        x1, y1, x2, y2 = bbox
        cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 255), 4) # in the frame draw a rectange with center at (x1,y1) and width and height of x2 and y2 respectively in red color with line thickness of 2
        ...
        cv2.putText(frame, class_name, (x1, y1-5), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 4)
